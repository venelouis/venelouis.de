...
const translations = {
  pt: {
    ...
    "hero.lede":
      "Eu sou Venelouis, educador, facilitador do Google Arcade Brasil 2026 e ex-aluno da Universidade Hebraica de Jerusalém. Mentor de alunos que buscam certificações AWS, Microsoft e outras, meu trabalho une fé, ciência, tecnologia e experiências de aprendizagem com impacto real.",
  ...
  en: {
    ...
    "hero.lede":
      "I am Venelouis, an educator, Google Arcade Brazil 2026 facilitator, and alumnus of the Hebrew University of Jerusalem. A mentor for students seeking AWS, Microsoft, and other certifications, my work blends faith, science, technology, and learning experiences with real impact.",
